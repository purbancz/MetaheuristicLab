...
def factory_ErraticPSO(p):
    return ErraticPSO(
        ...
        erratic_fraction=0.380225883274424,
        termination_criterion=StoppingByEvaluations(max_evaluations=G_MAX_EVALUATIONS)
    )
...
def factory_WandererPSO(p):
    return WandererPSO(
        ...
        wanderer_fraction=0.112113689734281,
        termination_criterion=StoppingByEvaluations(max_evaluations=G_MAX_EVALUATIONS)
    )
...
def factory_HybridFullDisjointPSO_WithRandom(p):
    return HybridFullDisjointPSO_WithRandom(
        ...
        rejector_fraction=0.02737752752212409,
        defeatist_fraction=0.13524720356617492,
        escapist_fraction=0.07081522704589124,
        amnesiac_fraction=0.018750044512650832,
        rebel_fraction=0.25217556724937096,
        contrarian_fraction=0.3255896823054203,
        eschewer_fraction=0.07549140505427815,
        anarchic_fraction=0.09455334274408946,
        constraint_handling_mode="clip",
        assign_roles_every_iteration=True,
        termination_criterion=StoppingByEvaluations(max_evaluations=G_MAX_EVALUATIONS)
    )
