...
echo "SLURM_NTASKS: $SLURM_NTASKS" # Will be 1
echo "SLURM_CPUS_PER_TASK: $SLURM_CPUS_PER_TASK" # Will be 48
echo "-------------------------------------------"

echo "Loading modules..."
module load miniconda3
# module load ... other necessary modules ...
...
# *** Use srun to launch the single task (still good practice) ***
# Or just run python directly here, as ntasks=1
# python -u $HOME/GA-PSO_Hybrid/main.py
srun python -u $HOME/GA-PSO_Hybrid/main_array.py # srun ensures environment consistency
