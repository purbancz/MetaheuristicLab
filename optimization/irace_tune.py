...
#     # Separate run
    ...
    Real("contrarian_fraction", 0.05, 0.8),  # Fraction of rebel particles
    Real("defeatist_fraction", 0.05, 0.8),  # Fraction of rejector particles
    Integer("window_size", 10, 50),  # Window size for convergence
    Real("max_contrarian_fraction", 0.1, 0.98),  # Max limit for rebel fraction
    Real("max_defeatist_fraction", 0.1, 0.98),  # Max limit for a rejector fraction
